...
-- AddForeignKey
ALTER TABLE "entry_types" ADD CONSTRAINT "entry_types_aggregate_id_fkey" FOREIGN KEY ("aggregate_id") REFERENCES "entry_types"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "entry_types" ADD CONSTRAINT "entry_types_collection_id_fkey" FOREIGN KEY ("collection_id") REFERENCES "collections"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
